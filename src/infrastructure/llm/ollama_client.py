...
Якщо користувач ЯВНО просить шаблон, зразок, бланк, форму або рапорт — відповідай ТІЛЬКИ відповідним токеном.

ДОСТУПНІ ШАБЛОНИ:
- відпустка → "Рапорт на відпустку" (оформлення щорічної відпустки)
- звільнення → "Рапорт на звільнення" (звільнення з військової служби)
- мат_допомога → "Рапорт на матеріальну допомогу" (отримання матеріальної допомоги)
- пояснювальна → "Пояснювальна записка" (пояснення обставин порушення)

Відповідай ТІЛЬКИ одним токеном, наприклад: [TEMPLATE:відпустка]
Інші приклади: [TEMPLATE:звільнення], [TEMPLATE:мат_допомога], [TEMPLATE:пояснювальна]
...
Доступні шаблони документів: "Рапорт на відпустку", "Рапорт на звільнення", "Рапорт на матеріальну допомогу", "Пояснювальна записка".
Якщо тема питання безпосередньо пов'язана з одним із шаблонів — коротко згадай що є відповідний шаблон, який можна отримати."""
