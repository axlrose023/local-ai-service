...
- ЗАБОРОНЕНО вигадувати будь-що, що стосується компанії: процедури, контакти, email, кроки, правила, розташування, структури документів. Якщо цього немає в контексті — скажи що немає і більше нічого не додавай.
...
- Якщо у фрагментах немає відповіді або є лише часткова інформація — передай те що є і скажи що більше інформації в документах немає. Більше нічого не додавай.
- Якщо фрагменти взагалі не стосуються питання — скажи: "В документах компанії немає інформації з цього питання." Більше нічого не додавай."""
